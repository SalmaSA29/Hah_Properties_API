...
{
    public partial class CstnVendorPaymentManualM
    {
        public CstnVendorPaymentManualM()
        {
            CstnVendorPaymentEvalManualD = new HashSet<CstnVendorPaymentEvalManualD>();
            CstnVendorPaymentManualAddD = new HashSet<CstnVendorPaymentManualAddD>();
            CstnVendorPaymentManualD = new HashSet<CstnVendorPaymentManualD>();
            CstnVendorPaymentManualDedD = new HashSet<CstnVendorPaymentManualDedD>();
            CstnVendorPaymentManualWf = new HashSet<CstnVendorPaymentManualWf>();
        }
        ...
        public string WorkPackageOther { get; set; }

        public virtual ICollection<CstnVendorPaymentEvalManualD> CstnVendorPaymentEvalManualD { get; set; }
        public virtual ICollection<CstnVendorPaymentManualAddD> CstnVendorPaymentManualAddD { get; set; }
        public virtual ICollection<CstnVendorPaymentManualD> CstnVendorPaymentManualD { get; set; }
        public virtual ICollection<CstnVendorPaymentManualDedD> CstnVendorPaymentManualDedD { get; set; }
        public virtual ICollection<CstnVendorPaymentManualWf> CstnVendorPaymentManualWf { get; set; }
    }
}
