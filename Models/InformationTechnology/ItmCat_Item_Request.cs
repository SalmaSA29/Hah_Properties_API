...
{
    public partial class ItmCat_Item_Request
    {
        public ItmCat_Item_Request()
        {
            Items_Attaches = new HashSet<ItmCat_Item_Request_Attach>();
        ...
        public virtual ICollection<ItmCat_Item_Request_Attach> Items_Attaches { get; set; }
