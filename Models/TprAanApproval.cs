...
{
    public partial class TprAanApproval
    {
        public TprAanApproval()
        {
            TprAanApprovalAansupplier = new HashSet<TprAanApprovalAansupplier>();
            TprAanApprovalSupplier = new HashSet<TprAanApprovalSupplier>();
            TprAanNegotiationD = new HashSet<TprAanNegotiationD>();
        }
        ...
        public string SeniorProcManagerUserId { get; set; }
        public string SeniorProcManagerComment { get; set; }
        public DateTime? SeniorProcManagerDate { get; set; }
        ...
        public bool? SendToRisk { get; set; }
        public string InUser { get; set; }
        public DateTime? InDate { get; set; }
        public string ModUser { get; set; }
        public DateTime? ModDate { get; set; }
        public string CostId { get; set; }
        public bool? SrCcm { get; set; }

        public virtual ICollection<TprAanApprovalAansupplier> TprAanApprovalAansupplier { get; set; }
        public virtual ICollection<TprAanApprovalSupplier> TprAanApprovalSupplier { get; set; }
        public virtual ICollection<TprAanNegotiationD> TprAanNegotiationD { get; set; }
    }
}
