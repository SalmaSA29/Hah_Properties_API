...
{
    public partial class CstnVendorPaymentManualWoodM
    {
        public CstnVendorPaymentManualWoodM()
        {
            CstnVendorPaymentEvalManualWoodD = new HashSet<CstnVendorPaymentEvalManualWoodD>();
            CstnVendorPaymentManualWoodD = new HashSet<CstnVendorPaymentManualWoodD>();
        }
        ...
        public virtual ICollection<CstnVendorPaymentEvalManualWoodD> CstnVendorPaymentEvalManualWoodD { get; set; }
        public virtual ICollection<CstnVendorPaymentManualWoodD> CstnVendorPaymentManualWoodD { get; set; }
    }
}
